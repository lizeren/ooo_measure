...
sns.histplot(data['Hit'], kde=False, bins=30, ax=axs[0, 0])
axs[0, 0].set_title('Histogram of "Hit" Values')

sns.histplot(data['Miss'], kde=False, bins=30, ax=axs[0, 1])
axs[0, 1].set_title('Histogram of "Miss" Values')

sns.histplot(data['In'], kde=False, bins=30, ax=axs[1, 0])
axs[1, 0].set_title('Histogram of "In" Values')

sns.histplot(data['Out'], kde=False, bins=30, ax=axs[1, 1])
